...
<div class="menuGrid mt-5">
    ...
    <a href="controlle.php" class="btn btn-dark m-3 menuBtns links d-flex flex-column justify-content-center align-items-center">
        ...
        <h4 class="mt-2">Controller un client</h4>
    </a>
    <a href="activity.php" class="btn btn-dark m-3 menuBtns links d-flex flex-column justify-content-center align-items-center">
        ...
        <h2 class="mt-2">Gérer les activités</h2>
    </a>
</div>
