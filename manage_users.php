...
<div class="container text-center mt-5">
    <?php if ($users) { ?>
        ...
        <table class="table ">
            ...
            <tr>
                ...
                <th scope="col">Actions utilisateur</th>
            ...
            foreach ($users as $role){
                ...
                <tr>
                    ...
                    <th><a href="action_user.php?id=<?=$role['id'] ?>"><button class="btn btn-success">Actions</button></a></th>
                    <th>
 ...
 <?php   }
    ...
    <h2 class="text-secondary">Créer un utilisateur</h2>
    <form method="post">
